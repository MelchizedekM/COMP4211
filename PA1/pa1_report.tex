...
After testing these methods, we can find the following insights:
...
\begin{itemize}
    ...
    \item mode - this method will fill the missing values with the mode of the feature column. This method is suitable for categorical or discrete data to maintain representativeness, but it may not be ideal for continuous data due to potential distortions in the distribution
...
\begin{table}[h!]
    \begin{tabular}{@{}clccc@{}}
        ...
        \midrule
        1 & \begin{tabular}[c]{@{}l@{}}Activation: tanh, Alpha: 0.0001, \\ Hidden Layers: (50, 50, 50), \\ Learning Rate: constant, Solver: sgd\end{tabular} & 0.8425 & 0.0216 \\
        2 & \begin{tabular}[c]{@{}l@{}}Activation: tanh, Alpha: 0.0001, \\ Hidden Layers: (50, 50, 50), \\ Learning Rate: constant, Solver: adam\end{tabular} & 0.8675 & 0.0092 \\
        3 & \begin{tabular}[c]{@{}l@{}}Activation: tanh, Alpha: 0.0001, \\ Hidden Layers: (50, 50, 50), \\ Learning Rate: adaptive, Solver: sgd\end{tabular} & 0.8460 & 0.0196 \\
        4 & \begin{tabular}[c]{@{}l@{}}Activation: tanh, Alpha: 0.0001, \\ Hidden Layers: (50, 50, 50), \\ Learning Rate: adaptive, Solver: adam\end{tabular} & 0.8675 & 0.0092 \\
        5 & \begin{tabular}[c]{@{}l@{}}Activation: tanh, Alpha: 0.0001, \\ Hidden Layers: (100, 100, 100), \\ Learning Rate: constant, Solver: sgd\end{tabular} & 0.8506 & 0.0104 \\
        \bottomrule
    \end{tabular}
